	...
	<div class="full-page">
		<div class="login-page clearfix">
			<div class="main-columns">
				<div id="login_area">
					<div id="input_area" class="selecttypeh2page">
						<div id="button_area" class="examloginbtn">
						<img class="selecttypeh2img" src="__PUBLIC__/images/home/selecttypeh2.png" alt="" />
					...
					<div class="cbuttonbox">
						<button title="<?php echo ($sappid); ?>" class="examselectbtn sutudyapp">题库练习</button>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<button title="<?php echo ($sappid); ?>" class="examselectbtn gototest">开始考试</button>
					</div>
				</div>
			</div>
		</div>
