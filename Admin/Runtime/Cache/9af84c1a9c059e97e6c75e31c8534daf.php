      ...
      <tr>
        <td width="100%" align="center">
          <div id="wrapper">
           ...
           <?php if(isset($closeWin)): ?><p class="notice">系统将在 <span style="color:blue;font-weight:bold"><?php echo ($waitSecond); ?></span> 秒后自动关闭，如果不想等待,直接点击 <a class="aclickhrer" href="<?php echo ($jumpUrl); ?>">这里</a> 关闭</p><?php endif; ?>
           <?php if(!isset($closeWin)): ?><p class="notice">系统将在 <span style="color:blue;font-weight:bold"><?php echo ($waitSecond); ?></span>秒后自动跳转，如果不想等待,直接点击 <a class="aclickhrer" href="<?php echo ($jumpUrl); ?>">这里</a> 关闭</p><?php endif; ?>
          </div>
        </td>
      </tr>
    </table></td>
