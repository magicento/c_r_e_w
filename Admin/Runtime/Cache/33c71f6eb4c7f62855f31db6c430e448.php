  ...
  <tr>
    ...
    <div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="##" target="main">应用列表</a></li>
          <li><a href="##" target="main">添加应用</a></li>
          <li><a href="##" target="main">考题管理</a></li>
          <li><a href="##" target="main">软件管理</a></li>
        </ul>
      </div>
      <?php if(1==2){ ?>
      ...
      <div class="content">
        ...
        <ul class="MM">
          ...
          <li><a href="##" target="main">其它文章</a></li>
        </ul>
      </div>
      </div>
