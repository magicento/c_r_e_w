    ...
    <div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
          ...
          <li><a href="__APP__/Config/order" target="main">交易管理</a></li>
        </ul>
      </div>
      ...
      <h1 class="type"><a href="javascript:void(0)">程序版本与技术支持</a></h1>
     		<ul class="devinfo" style="color:#ddd;">
     			<li><?php echo (session('website_sitename2')); ?>-[测试版]</li>
     			<li>开发：<a style="color:#ddd;" href="mailto:zhang.jiachao@qq.com">Jochen.zhang</a></li>
     			<li>CopyRight©2012-<?php echo date('Y',time()); ?></li>
     		</ul>
      </div>
		...
		function con(event){
			if(confirm("友情提示，退出系统请点击系统的右上角的  退出按钮！")){
				return true;
			}
			return false;
		}
		window.onbeforeunload = con();
