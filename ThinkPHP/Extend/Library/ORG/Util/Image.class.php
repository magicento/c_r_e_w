...
class Image {
     ...
     * 使用方法：
     * session_start(); 
	 * vCode(4,55,verify); //4个数字，显示大小为15
     */
    function vCode($num = 4, $size = 20, $verifyName='verify', $width = 0, $height = 0,$fontface="simhei.ttf") {
    	...
    	// 画验证码
    	@imagefttext($im, $size , 0, 5, $size + 3, $text_color, $fontface, $code);
